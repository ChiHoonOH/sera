...
<body id="page-top">
	...
	<nav class="navbar navbar-expand navbar-dark bg-dark static-top">
		...
		<a class="navbar-brand mr-1" href="/">4조
			사이트</a>
									...
									<table>
										...
										<tr>
											...
											<td><input style="width: 500px" type="text" id="url"
												name="url" value="${result.url }" /></td>
										</tr>
									</table>
									<div>
										<a href='#' onClick='fn_update()' class="btn btn-success">수정</a>
										<a href='#' onClick='fn_view()' class="btn btn-success">목록</a>
										<a href='#' onClick='fn_delete()' class="btn btn-success">삭제</a>
