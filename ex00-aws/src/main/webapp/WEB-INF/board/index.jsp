...
<body id="page-top">
	...
	<nav class="navbar navbar-expand navbar-dark bg-dark static-top">
		...
		<a class="navbar-brand mr-1" href="/">4조 사이트</a>
	...
	<div id="wrapper">
		...
		<ul class="sidebar navbar-nav">
			...
			<li class="nav-item"><a class="nav-link" href="/5_analysis">
					<i class="fas fa-fw fa-chart-area"></i> <span>18년 5월 토픽 키워드</span>
			</a></li>
				<li class="nav-item"><a class="nav-link" href="/6_analysis">
					<i class="fas fa-fw fa-chart-area"></i> <span>18년 6월 토픽 키워드</span>
			</a></li>
				<li class="nav-item"><a class="nav-link" href="/7_analysis">
			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						<i class="fas fa-chart-area"></i> 3줄 요약
					</div>
					<div class="card-body">
						<c:url value="/url" var="actionURL" scope="page" />
						<form action="./summary" method="get">
							<p>
								<strong>URL : </strong> <input name="name" type="text" size="70"
									placeholder="URL 입력"> <input type="submit" value="입력"
				...
				<div class="card mb-3">
					<div class="card-header">
						<i class="fas fa-table"></i> 나만의 스크랩 게시판
					</div>
					<div class="container">
						<form id="boardForm" name="boardForm" method="post">
							...
							<div>
								<a href='#' onClick='fn_write()' class="btn btn-success">스크랩</a>
							</div>
						</form>
					</div>
...
function fn_view(code){
    ...
    var form = document.getElementById("boardForm");
    var url = "<c:url value='/viewContent'/>";
    url = url + "?code=" + code;
